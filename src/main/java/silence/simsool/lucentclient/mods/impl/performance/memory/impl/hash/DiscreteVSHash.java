...
import silence.simsool.lucentclient.mixin.accessors.memoryleak.BitSetDVSAccess;
import silence.simsool.lucentclient.mixin.accessors.memoryleak.DiscreteVSAccess;
import silence.simsool.lucentclient.mixin.accessors.memoryleak.SubShapeAccess;
...
public class DiscreteVSHash implements Hash.Strategy<DiscreteVoxelShape> {
	...
	public int hashCode(DiscreteVSAccess o) {
		...
		else return 31 * result + Objects.hashCode(o);
	}
	...
	public boolean equals(DiscreteVSAccess a, DiscreteVSAccess b) {
		...
		if (a instanceof SubShapeAccess accessA) {
			...
			return accessA.getEndX() == accessB.getEndX() && accessA.getEndY() == accessB.getEndY()
					&& accessA.getEndZ() == accessB.getEndZ() && accessA.getStartX() == accessB.getStartX()
					&& accessA.getStartY() == accessB.getStartY() && accessA.getStartZ() == accessB.getStartZ()
			...
			return accessA.getXMax() == accessB.getXMax() && accessA.getYMax() == accessB.getYMax()
					&& accessA.getZMax() == accessB.getZMax() && accessA.getXMin() == accessB.getXMin()
					&& accessA.getYMin() == accessB.getYMin() && accessA.getZMin() == accessB.getZMin()
