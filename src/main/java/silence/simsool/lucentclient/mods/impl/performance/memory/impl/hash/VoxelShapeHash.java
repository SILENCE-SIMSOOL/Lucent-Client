...
import silence.simsool.lucentclient.mixin.accessors.memoryleak.VoxelShapeAccess;
...
public class VoxelShapeHash implements Hash.Strategy<VoxelShape> {
	...
	public int hashCode(VoxelShapeAccess o) {
		if (o instanceof SliceShapeAccess access) return SliceShapeHash.INSTANCE.hashCode(access);
		else if (o instanceof ArrayVSAccess access) return ArrayVoxelShapeHash.INSTANCE.hashCode(access);
		else if (isCubeShape(o)) return DiscreteVSHash.INSTANCE.hashCode(o.getShape());
	...
	public boolean equals(VoxelShapeAccess a, VoxelShapeAccess b) {
		...
		else if (a instanceof SliceShapeAccess accessA) return SliceShapeHash.INSTANCE.equals(accessA, (SliceShapeAccess) b);
		else if (a instanceof ArrayVSAccess accessA) return ArrayVoxelShapeHash.INSTANCE.equals(accessA, (ArrayVSAccess) b);
		else if (isCubeShape(a)) return DiscreteVSHash.INSTANCE.equals(a.getShape(), b.getShape());
